...
if __name__ == '__main__':
    command_run = 'python -m scripts.inference_runner --data-file-path datasets/houston/houston.npy ' \
                  ...
                  '--channels-idx -1 --spost test --post gaussian --noise-params "{\"mean\":0,\"std\":0.01,\"pa\":0.1,\"pb\":1,\"bc\":true}" ' \
                  '--use-mlflow True --experiment-name houston --run-name balanced_gaussian_test_pa01'
