...
def train_val_test_split(data: np.ndarray, labels: np.ndarray,
                         ...
                         val_size: float = 0.1,
                         balanced: bool = True,
                         background_label: int = 0) -> typing.Tuple[np.ndarray, np.ndarray, np.ndarray, np.ndarray, np.ndarray, np.ndarray]:
    """
...
def reshape_to_1d_samples(data: np.ndarray,
                          labels: np.ndarray,
                          channels_idx: int = 0) -> typing.Tuple[np.ndarray, np.ndarray]:
    """
