...
def main(args):
    ...
    # Init data
    data = build_training_set(args.original, args.gt_file, args.area, args.stddev, args.diagonal, args.moment, args.train_samples_per_class, args.neighbours_size, args.classes_count)
