...
from ml_intuition.models import _get_model
...
class TestModels:
    ...
    def test_get_model(self, model_key, kernel_size,
        ...
        model = _get_model(model_key, kernel_size=kernel_size, n_kernels=n_kernels,
                           n_layers=n_layers, input_size=input_size, n_classes=n_classes)
